...
import nnunet_LEM
from nnunet_LEM.paths import network_training_output_dir, preprocessing_output_dir, default_plans_identifier
from batchgenerators.utilities.file_and_folder_operations import *
from nnunet_LEM.experiment_planning.summarize_plans import summarize_plans
...
def get_default_configuration(network, task, network_trainer, plans_identifier=default_plans_identifier,
                              search_in=(nnunet_LEM.__path__[0], "training", "network_training"),
                              base_module='nnunet_LEM.training.network_training'):
