...
from nnunet_LEM.paths import nnUNet_raw_data, nnUNet_cropped_data
import numpy as np
import pickle
from nnunet_LEM.preprocessing.cropping import get_patient_identifiers_from_cropped_files
