...
from nnunet_LEM.experiment_planning.DatasetAnalyzer import DatasetAnalyzer
from nnunet_LEM.experiment_planning.utils import crop
from nnunet_LEM.paths import *
import shutil
from nnunet_LEM.utilities.task_name_id_conversion import convert_id_to_task_name
from nnunet_LEM.preprocessing.sanity_checks import verify_dataset_integrity
from nnunet_LEM.training.model_restore import recursive_find_python_class
...
def main():
    ...
    search_in = join(nnunet_LEM.__path__[0], "experiment_planning")

    if planner_name3d is not None:
        planner_3d = recursive_find_python_class([search_in], planner_name3d, current_module="nnunet_LEM.experiment_planning")
    ...
    if planner_name2d is not None:
        planner_2d = recursive_find_python_class([search_in], planner_name2d, current_module="nnunet_LEM.experiment_planning")
